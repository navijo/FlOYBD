...
class Station_limits(Model):
    ...
    maxMinPressure     = columns.Decimal(required=False,index=True)
    avgMinPressure     = columns.Decimal(required=False,index=True)
    minMinPressure     = columns.Decimal(required=False,index=True)
